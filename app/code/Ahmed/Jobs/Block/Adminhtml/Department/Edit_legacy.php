...
namespace Ahmed\Jobs\Block\Adminhtml\Department;

use Magento\Backend\Block\Widget\Form\Container;

class Edit_legacy extends Container
{
    /**
     * Core registry
     *
    ...
    {
        $this->_objectId = 'id';
        $this->_blockGroup = 'Ahmed_Jobs';
        $this->_controller = 'adminhtml_department';

        parent::_construct();

        if ($this->_isAllowedAction('Ahmed_Jobs::department_save')) {
